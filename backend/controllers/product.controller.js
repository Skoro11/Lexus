...
export async function flashSaleProducts(req,res){
    ...
    try{
        const flashSaleProducts= products.filter(product => product.specialCategory ==="Flash Sales")
...
export async function bestSellingProducts(req,res){
    ...
    try{
        const bestSellingProducts = products.filter(product =>product.specialCategory=== "Best Selling")
...
export async function exploreProducts(req,res){
    ...
    try{
        const exploreProducts= products.filter(product =>product.specialCategory ==="Explore")
