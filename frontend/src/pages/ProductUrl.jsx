  ...
  return (
    <section className="my-12  ">
      ...
      <div className="max-h-100 md:ml-5 md:w-1/3">
        <img className="max-h-100 h-full w-full " src={product.image} alt={product.name} />
      </div>
      ...
      <div className="md:w-3/7">
        ...
        <div className="flex items-center">
          ...
          ({product.numOfReviews}) | <span className="pl-1 text-green-600">In Stock</span>
        </div>
        <div className="text-2xl">{product.price}$</div>
        <div className="mb-2">{product.description}</div>

        <div>
          <button className="bg-black text-white rounded py-2 px-4 mb-2 pointer hover:opacity-50 hover-change" onClick={() => addToCart(product)}>
            Add to Cart
          </button>
        </div>
        <div>
          <div className="hidden lg:block border rounded ">
            ...
            <div className=" md:flex py-2 pl-4 underline items-center">
              ...
              <div>
                ...
                <br />
                <span className="text-xs">Free 30 Days Delivery Returns</span>
              </div>
            </div>
          </div>
        </div>
              ...
              <Carousel title="Recommended for You" main ="Trending now" component={""} products={allProducts}/>
