    ...
    return(
        <section className="mx-8 my-12">
            ...
            <div className="mb-10 hidden md:flex">
                <a className=" text-gray-500" href="/">Home </a> / About
            </div>
            <div className="md:flex items-center mb-15 lg:mb-30">
               <div className="w-full md:w-6/12  ">
               <h1 className="text-5xl mb-10">Our Story</h1>
                <p className="mb-5  md:w-10/12 ">Launched in 2015, Lexus is South Asia’s premier online shopping marketplace with an active presence in Bangladesh. Supported by wide range of tailored marketing, data and service solutions, Lexus has 10,500 sallers and 300 brands and serves 3 millioons customers across the region. 

                </p>
                
                <p className="mb-5 md:w-10/12 ">Lexus has more than 1 Million products to offer, growing at a very fast. Lexus offers a diverse assortment in categories ranging  from consumer.</p>
           </div> 
           <div className="md:w-6/12 ">
            <img className="w-full" src="customers.png" alt="Customers" />
           </div>
           
           </div>


           <div className="hidden gap-4 text-center lg:flex justify-between mb-15 lg:mb-30 ">
            <div className="pointer flex-1 py-5 flex items-center justify-center flex-col border rounded-xl border-gray-400 gap-2 hover:bg-[#db4444] hover:text-white hover-change group">
                <div className="bg-black group-hover:bg-white flex p-4 rounded-full ">
                <svg width="35" height="32" viewBox="0 0 35 32" fill="none" xmlns="http://www.w3.org/2000/svg">
<path className="group-hover:stroke-black hover-change" d="M31.6416 1H24.9883L25.8216 9.33333C25.8216 9.33333 27.4883 11 29.9883 11C31.3006 11.0017 32.5684 10.524 33.5533 9.65667C33.6574 9.55938 33.735 9.43716 33.7787 9.30156C33.8224 9.16596 33.8309 9.02145 33.8033 8.88167L32.6266 1.83333C32.5873 1.60049 32.4668 1.38909 32.2865 1.23656C32.1062 1.08404 31.8778 1.00024 31.6416 1V1Z" stroke="white" strokeWidth="2"/>
<path className="group-hover:stroke-black hover-change" d="M24.9883 1L25.8216 9.33333C25.8216 9.33333 24.1549 11 21.6549 11C19.1549 11 17.4883 9.33333 17.4883 9.33333V1H24.9883Z" stroke="#FAFAFA" strokeWidth="2"/>
<path className="group-hover:stroke-black hover-change" d="M17.4886 1V9.33333C17.4886 9.33333 15.8219 11 13.3219 11C10.8219 11 9.15527 9.33333 9.15527 9.33333L9.98861 1H17.4886Z" stroke="#FAFAFA" strokeWidth="2"/>
<path className="group-hover:stroke-black hover-change" d="M9.98827 1H3.3366C3.09993 0.999912 2.87089 1.08377 2.69023 1.23666C2.50957 1.38955 2.38899 1.60157 2.34994 1.835L1.17494 8.88333C1.14747 9.02311 1.15601 9.16758 1.19974 9.30315C1.24348 9.43873 1.32097 9.56095 1.42494 9.65833C1.9716 10.1417 3.19327 11.0017 4.98827 11.0017C7.48827 11.0017 9.15494 9.335 9.15494 9.335L9.98827 1.00167V1Z" stroke="#FAFAFA" strokeWidth="2"/>
<path className="group-hover:stroke-black hover-change" d="M2.5 11V27.6667C2.5 28.5507 2.85119 29.3986 3.47631 30.0237C4.10143 30.6488 4.94928 31 5.83333 31H29.1667C30.0507 31 30.8986 30.6488 31.5237 30.0237C32.1488 29.3986 32.5 28.5507 32.5 27.6667V11" stroke="#FAFAFA" strokeWidth="2"/>
<path className="group-hover:stroke-black hover-change" d="M22.2217 31V21C22.2217 20.1159 21.8705 19.2681 21.2454 18.6429C20.6202 18.0178 19.7724 17.6666 18.8883 17.6666H15.555C14.671 17.6666 13.8231 18.0178 13.198 18.6429C12.5729 19.2681 12.2217 20.1159 12.2217 21V31" stroke="#FAFAFA" strokeWidth="2" strokeMiterlimit="16"/>
</svg>

                </div> 
                <div className="font-bold text-3xl">10.5k</div>
                <div>Sellers active our site</div>
          
            </div>
            <div className=" group pointer flex-1 py-5 flex items-center justify-center flex-col border rounded-xl border-gray-400 gap-2 hover:bg-[#db4444] hover:text-white hover-change">
                <div className="bg-black group-hover:bg-white flex p-4 rounded-full ">
                <svg className=" svg-icon" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path className="group-hover:stroke-black hover-change" d="M20.0003 37.2728C29.5397 37.2728 37.273 29.5395 37.273 20C37.273 10.4606 29.5397 2.72729 20.0003 2.72729C10.4608 2.72729 2.72754 10.4606 2.72754 20C2.72754 29.5395 10.4608 37.2728 20.0003 37.2728Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  <path className="group-hover:stroke-black hover-change" d="M25.0914 14.547C24.762 13.9758 24.2834 13.505 23.707 13.1848C23.1305 12.8646 22.4777 12.7072 21.8186 12.7294H18.1823C17.2178 12.7294 16.2929 13.1124 15.611 13.7941C14.929 14.4759 14.5459 15.4005 14.5459 16.3647C14.5459 17.3288 14.929 18.2535 15.611 18.9353C16.2929 19.617 17.2178 20 18.1823 20H21.8186C22.783 20 23.708 20.383 24.3899 21.0648C25.0719 21.7465 25.455 22.6712 25.455 23.6354C25.455 24.5995 25.0719 25.5242 24.3899 26.2059C23.708 26.8877 22.783 27.2707 21.8186 27.2707H18.1823C17.5232 27.2929 16.8704 27.1354 16.2939 26.8153C15.7174 26.4951 15.2389 26.0242 14.9095 25.453" stroke="white" strokeWidth="2.75" strokeLinecap="round" strokeLinejoin="round"/>
  <path className="group-hover:stroke-black hover-change" d="M20 8.18176V12.1212M20 27.8787V31.8181" stroke="white" strokeWidth="2.75" strokeLinecap="round" strokeLinejoin="round"/>
</svg>


                </div> 
                <div className="font-bold text-3xl">33k</div>
           ...
           <div className=" ">
            <div className="hidden lg:flex justify-between gap-10">
                <div className="flex flex-col flex-1 gap-2">
                    <img className="bg-gray-100 max-h-75 object-contain" src="will.png" alt="Personal" />
                <div className="font-bold text-3xl">Will Richadson</div>
                ...
                <div className="flex flex-col flex-1 gap-2">
                    <img className="bg-gray-100 max-h-75 object-contain" src="emma.png" alt="Personal" />
                <div className="font-bold text-3xl">Emma Willson</div>
                ...
                <div className="flex flex-col flex-1 gap-2">
                    <img className="bg-gray-100 max-h-75 object-contain" src="tom.png" alt="Personal" />
                <div className="font-bold text-3xl" >Tom Cruise</div>
